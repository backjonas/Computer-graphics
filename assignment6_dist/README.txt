...
R1 Sample diffuse and normal textures	(1p): not done
R2 Lambertian diffuse shading		(1p): not done
R3 GGX distribution function D		(1p): not done
R4 GGX shadowing-masking function G	(1p): not done
R5 Fresnel reflectivity coefficient Fr	(1p): not done
