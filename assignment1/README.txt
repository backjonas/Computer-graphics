# CS-C3100 Computer Graphics, Fall 2020
...
- Have you had something to do with graphics before? Other studies, personal interests, work?
	Very limited UI & graphics stuff in other courses, eg. sfml in C++
...
- How is your overall programming experience? What language are you most comfortable with?
	Programming experience of two years of studies and some months of working with C++, so quite average. I am most comfortable with Python & C++.
- Do you have some experience with these things? (If not, do you have experience with something similar such as C or Direct3D?)
C++: Aalto course in C++ & worked with C++
C++11: Mostly worked with C++14 & C++17, should be similar enough to C++11.
OpenGL: - 
